 ...
 */
public class HexagonalRuleGenerator implements Iterator<List<String>> {
    ...
    private List<String> generateRule() {
        List<String> result = new ArrayList<>();
        for (int move : intArray) {
            switch (move) {
                case 0 -> result.add("N");
                case 1 -> result.add("R1");
                case 2 -> result.add("R2");
                case 3 -> result.add("U");
                case 4 -> result.add("L2");
                case 5 -> result.add("L1");
            }
        }
        return result;
    }
