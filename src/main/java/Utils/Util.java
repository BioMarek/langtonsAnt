...
public class Util {
    ...
    public static List<Rule> getInteresting() {
        ...
        interesting.add(new Rule("RRLRLRRRRRLRRLL", 0, 1));
        interesting.add(new Rule("RRRRRRRRLLLLLLLL", 0, 1));
        ...
        interesting.add(new Rule("LRRLLLRLRLRRLLL", 0, 1));
        interesting.add(new Rule("LRRRRLLLRLRRRRL", 0, 1));
        interesting.add(new Rule("LRRRRLRRLLRRRRRL", 0, 1));
        ...
        interesting.add(new Rule("LLRLLLRRRRRLLRLL", 0, 1));
